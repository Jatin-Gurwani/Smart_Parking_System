...
while ret:
    ...
    ret, frame = cap.read()
    if ret:
        imgGraphics = cv2.imread("./Images/Entry_Graphics.png", cv2.IMREAD_UNCHANGED)
                ...
                if license_plate_text is not None:
                    ...
                    if car_id not in inserted_list :
                        ...
                        if Entry_log is False:
                            ...
                            inserted_license_plate = license_plate_text
        ...
        cv2.putText(frame, f'Total Visted :{var_Total_Car_Visited}', (95, 229), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1,
                        (100, 100, 55), 1)
        cv2.putText(frame, f'last detected :', (15, 299), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0), 2)
        cv2.putText(frame, f'{inserted_license_plate}', (15, 339), cv2.FONT_HERSHEY_COMPLEX_SMALL, 2, (0, 0, 0), 1)
